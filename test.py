...
if __name__ == '__main__':
    ...
    TEST_CSV_PATH           = os.getenv("TEST_CSV_PATH", "data/public_revised.csv")
    TEST_MODEL_PT_PATH      = os.getenv("TEST_MODEL_PT_PATH", "models/apan_best.pt")
    TEST_OUTPUT_CSV_PATH    = os.getenv("TEST_OUTPUT_CSV_PATH", "submission.csv")
